...
python server.py -source sextop1 -domain sextop1.menu -detail-threads 1 -news-threads 1 -port 5001 -proxy-threads 7 -chunk_size 512KB -max_connections 30 -max_keepalive 10 -timeout "connect=3.0,read=None" &
